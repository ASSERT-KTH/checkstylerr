...
public class TrainModelHandler extends DefaultSqlHandler {
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(TrainModelHandler.class);

  public TrainModelHandler(SqlHandlerConfig config, Pointer<String> textPlan) {
   ...
   *
   * For TMAS : Train Model m1 partition by (con_A) AS select * from T1;

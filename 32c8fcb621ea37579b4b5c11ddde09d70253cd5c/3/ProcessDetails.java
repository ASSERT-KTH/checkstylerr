...
public class ProcessDetails extends RestEntity {
    ...
    public Date getLastModificationTime() {
        if (lastModificationTime != null) {
            return new Date(lastModificationTime.getTime());
        }
        return null;
    }
    ...
    public Date getPredictedDueDate() {
        return Utils.cloneDate(predictedDueDate);
    }
    ...
    /**
     * @param creationTime Is creation time of the process instance.
     */
    public void setCreationTime(Date creationTime) {
        this.creationTime =  Utils.cloneDate(creationTime);
    }
    ...
    /**
     * @param lastModificationTime Is a new time a property of the process instance changed.
     */
    public void setLastModificationTime(Date lastModificationTime) {
        if (lastModificationTime != null) {
            this.lastModificationTime = new Date(lastModificationTime.getTime());
        }
    }
    ...
    /**
     * @param dueDate Is due date associated with the process instance.
     */
    ...
    /**
     * @param predictedDueDate Is predicted due date associated with the process instance.
     */
    public void setPredictedDueDate(Date predictedDueDate) {
        if (predictedDueDate != null) {
            this.predictedDueDate = new Date(predictedDueDate.getTime());
        }
    }

...
public class Diagram extends RestEntity {
    ...
    //A list of zero or more milestones associated with the process.
    //A milestone represents a phase of process execution.
    ...
    /**
     * @return A list of zero or more milestones associated with the process.
     *      A milestone represents a phase of process execution.
     */
    ...
    /**
     * @return A list of zero or more lanes associated with the process.
     *      A 'lane' typically represents a department within a business organization.
     */
